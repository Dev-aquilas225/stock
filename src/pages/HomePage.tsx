        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          >
            <div className="inline-flex items-center px-4 py-2 bg-nexsaas-saas-green/10 rounded-full text-nexsaas-saas-green font-medium text-sm mb-6">
              ...
              Nouvelle version : Agent IA et Retours Approvisionnements
            </div>
            <h1 className="text-5xl md:text-6xl font-extrabold text-nexsaas-deep-blue dark:text-nexsaas-pure-white mb-6 tracking-tight">
              Boostez votre entreprise avec <span className="bg-gradient-to-r from-nexsaas-deep-blue to-nexsaas-saas-green bg-clip-text text-transparent">NexSaaS</span>
            </h1>
            <p className="text-xl md:text-2xl text-nexsaas-vanta-black dark:text-gray-200 mb-10 max-w-3xl mx-auto leading-relaxed">
              La plateforme ERP tout-en-un pour gérer vos stocks, ventes, retours et affiliés. <span className="text-nexsaas-saas-green font-semibold">+40% de revenus</span> en moyenne.
            </p>
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-lg text-nexsaas-vanta-black dark:text-gray-300 max-w-2xl mx-auto">
              Une solution ERP conçue pour simplifier et accélérer la croissance de votre entreprise.
            </p>
          </motion.div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-lg text-nexsaas-vanta-black dark:text-gray-300 max-w-2xl mx-auto">
              Une suite complète pour gérer vos processus métier avec efficacité.
            </p>
          </motion.div>
              ...
              >
                <Link to={module.link}>
                  <Card className="h-full p-6 hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 group">
                    <div className={`p-4 bg-gradient-to-r ${module.color} rounded-lg inline-block mb-4 group-hover:scale-105 transition-transform`}>
          ...
          <div className="flex justify-center mt-6 space-x-2">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-colors ${index === activeTestimonial ? 'bg-nexsaas-saas-green' : 'bg-gray-300 dark:bg-gray-600'}`}
              />
            ))}
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
              {plans.map((plan) => (
                <div key={plan.id} className="relative">
                  ...
                  <Card
                    className={`max-w-[200px] min-h-[400px] flex flex-col justify-between text-center p-3 border ${plan.nom === 'starter'
                  ...
                  >
                    <div>
                      ...
                      <div className="mb-2">
                        ...
                        {plan.prix !== 0 && plan.nom !== 'entreprise' && (
                          <span className="text-nexsaas-vanta-black dark:text-gray-300 text-sm">/mois</span>
                        )}
                      </div>
                    ...
                    <Link to="/inscription" className="block">
                      <Button
                        variant={plan.nom === 'starter' ? 'primary' : 'outline'}
                        className="w-full bg-nexsaas-saas-green text-white hover:bg-green-600 text-sm"
                        size="md"
                      >
                        {plan.nom === 'entreprise' ? 'Faire un devis' : 'Commencer'}
